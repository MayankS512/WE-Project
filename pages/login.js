...
const Login = () => {
  ...
  return ( 
    <div className="absolute top-0 flex items-center justify-center w-full h-full overflow-x-hidden">
      ...
      <button id="goback" onClick={() => {router.back()}} className="w-16 h-16 font-serif transition-colors duration-300 scale-0 bg-gray-800 rounded-full shadow-lg hover:bg-gray-700 shadow-gray-900 focus:outline-offset-4 focus:outline-gray-700"> 
      &larr;
      </button>
      <h1 className="ml-10 text-4xl lg:text-8xl font-Cinzel">Rudiment.</h1>
      </div>
        ...
        <div className="absolute flex flex-col ml-32 text-center rounded-md shadow-lg right-80 w-96 dark:bg-neutral-700 bg-zinc-100 shadow-black">
          ...
          <button className="py-2 mx-10 mb-8 text-xl transition-all duration-300 bg-gray-800 hover:bg-gray-700 focus:outline-0 focus:bg-gray-700">Login</button>
          <button className="py-2 mx-10 mb-8 text-xl transition-all duration-300 bg-gray-800 shadow-sm hover:bg-gray-700 focus:outline-0 focus:bg-gray-700">Register</button>
        </div>
