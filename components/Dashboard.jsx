...
const Dashboard = ({ server }) => {
  ...
  return (
    <div id='messages' className='flex flex-col w-full h-full col-span-3 overflow-auto md:col-span-2 lg:col-span-3 xl:col-span-4'>
      <div className='p-2 pb-0 text-xl select-none'>To Invite: <span className='select-text '>{server.last}</span></div>
      
      <div className='flex flex-col-reverse flex-grow p-2 m-2 mb-0 overflow-auto rounded-md bg-zinc-800'>
