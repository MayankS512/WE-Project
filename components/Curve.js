    ...
    <>
      <svg height="100%" width="100%" xmlns="http://www.w3.org/2000/svg">
        ...
        <path id="blob">
          ...
          M266.8 -505.1C373.9 -400.2 508.2 -385.6 614.3 -316.5C720.4 -247.3 798.2 -123.7 791 -4.2C783.8 115.3 691.5 230.7 576.8 284.8C462 338.9 324.8 331.8 224.9 425.2C125 518.5 62.5 712.3 -7.1 724.5C-76.7 736.8 -153.3 567.6 -209.6 449.1C-265.9 330.6 -301.8 262.8 -370.7 196.4C-439.5 130 -541.2 65 -546.9 -3.2C-552.5 -71.5 -462 -143 -395.2 -212.9C-328.3 -282.7 -285.2 -350.9 -223.3 -481.9C-161.3 -612.8 -80.7 -806.4 -0.4 -805.7C79.8 -804.9 159.7 -609.9 266.8 -505.1;
          
          M240.8 -437.4C342.3 -358.5 475.5 -355 552.2 -294.7C628.9 -234.3 648.9 -117.2 664.7 9.1C680.4 135.3 691.8 270.7 607.6 318C523.5 365.4 343.7 324.7 226.5 365.9C109.3 407 54.7 530 -12.7 552C-80 573.9 -160 494.8 -219.6 420.4C-279.2 346 -318.4 276.2 -387.9 206.9C-457.4 137.7 -557.2 68.8 -559.5 -1.3C-561.8 -71.5 -466.7 -143 -383 -187.7C-299.2 -232.3 -227 -250.1 -165 -351.9C-103.1 -453.6 -51.6 -639.3 9.1 -655C69.7 -670.7 139.3 -516.3 240.8 -437.4"  />
        </path>
        </clipPath>
      </svg>
      <div className='fixed h-screen top-48 left-60 -z-10 clip'>
        <div id="bg" className="fixed w-[1100px] h-[1000px] -top-10 -left-10 "></div>
      </div>
    </>
  );
}
